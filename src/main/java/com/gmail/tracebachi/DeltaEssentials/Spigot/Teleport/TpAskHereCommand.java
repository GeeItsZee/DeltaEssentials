 ...
 */
public class TpAskHereCommand implements TabExecutor, Registerable
{
  private static final String COMMAND_NAME = "tpahere";
  private static final String COMMAND_USAGE = "/tpahere <name>";
  private static final String COMMAND_PERM = "DeltaEss.Tp.OtherToMe.Ask";
  ...
  public boolean onCommand(CommandSender sender, Command command, String s, String[] args)
  {
    ...
    tpHereManager.tpAskHere(args[0], (Player) sender, ignoreBlocking, ignoreVanish);
    return true;
  }
}
