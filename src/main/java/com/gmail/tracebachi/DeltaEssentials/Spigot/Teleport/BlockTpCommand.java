 ...
 */
public class BlockTpCommand implements CommandExecutor, Registerable
{
  private static final String COMMAND_NAME = "blocktp";
  private static final String COMMAND_PERM = "DeltaEss.BlockTp";
  private static final String COMMAND_USAGE = "/blocktp <on|off>";
  private static final String SETTING_NAME = "BlockTp";

  private final DeltaEssentialsPlugin plugin;
  private final MessageFormatMap formatMap;

  public BlockTpCommand(
  ...
  public boolean onCommand(CommandSender sender, Command command, String s, String[] args)
  {
    ...
    {
      playerFile.setBlockingTeleports(true);
    ...
    {
      playerFile.setBlockingTeleports(false);
